          ...
          for (int guess3 = 0; guess3 <= 9; guess3++) {
            for (int guess4 = 0; guess4 <= 9; guess4++) {
              ...
              if (true
                  ...
                  && check(guesses, 0, 0, 0, 2, 1, 8, 7) // 98721 - All digits are wrong
                  && check(guesses, 1, 0, 1, 3, 5, 7, 9) // 13579 - Two digits are right, but in the wrong place
              ) {
